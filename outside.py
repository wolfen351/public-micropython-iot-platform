from boot import PIN_D0, PIN_D1, PIN_D2, PIN_D3, PIN_D4, PIN_D5, PIN_D6, PIN_D7, PIN_D8, PIN_LED
...
Period4 = Delay0 + Delay1 + Delay2 + Delay3 + Delay4
Periods = [Period0, Period1, Period2, Period3, Period4]
...
while True:
    ...
    for l in range(5):
        ...
        if (Trigger1 == 1):
            ...
            LightOffAt[l] = atLeast(LightOffAt[l], Periods[4-l] + TimeOn)

        # If trigger 2 is set, then go downwards
        if (Trigger2 == 1):
            LightOnAt[l] = atMost(LightOnAt[l], Periods[4-l])
    ...
    # Debug output
    print(Trigger1, Trigger2, " - ", LightOnAt[0], LightOffAt[0], LightOnAt[1], LightOffAt[1], LightOnAt[2], LightOffAt[2], LightOnAt[3], LightOffAt[3], LightOnAt[4], LightOffAt[4])
