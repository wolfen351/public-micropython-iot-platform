...
class LedStripSettings:
    ...
    def __init__(self, ledAction = b"rainbow", ledColorPrimary = b"000000", ledColorSecondary = b"000000", ledBrightness = 255):
    ...
    def write(self):
        ...
        if self.is_valid():
            with open(self.SETTINGS_FILE, "wb") as f:
                f.write(b",".join([self.ledAction, self.ledColorPrimary, self.ledColorSecondary, str(self.ledBrightness).encode('ascii')]))
    ...
    def load(self):
        ...
        try:
            ...
            if len(contents) == 4:
                ...
                self.ledBrightness = int(contents[3])
    ...
    def is_valid(self):
        ...
        if not isinstance(self.ledColorSecondary, bytes):
            return False
        if not isinstance(self.ledBrightness, int):
            return False
        return True
